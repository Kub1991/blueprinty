            ...
            <div className="flex gap-4 pr-6">
                {creators.map((creator) => {
                    ...
                    return (
                        ...
                        >
                            <div
                                className={`relative p-[3px] rounded-full transition-all duration-300 ${isSelected
                            ...
                            >
                                <div className="bg-white p-[2px] rounded-full">
                                    <img
                                        src={creator.avatar}
                                        alt={creator.name}
                                        className={`w-14 h-14 rounded-full object-cover border border-gray-100 transition-transform duration-300 ${isSelected ? 'scale-95' : 'group-hover:scale-105'
                                            }`}
                                    />
                                </div>
                                {isSelected && (
                            ...
                            <span
                                className={`text-[11px] text-center truncate w-full ${isSelected ? 'font-bold text-black' : 'font-medium text-gray-500'
                                    }`}
                            >
                                {creator.name}
                            </span>
