                    ...
                    <div className="relative pl-6 space-y-8 border-l-2 border-dashed border-gray-200 ml-6">
                        {dayPoints.map((point) => (
                            ...
                            >
                                {/* Connector Dot */}
                                <div
                                    className={`absolute -left-[31px] top-1/2 -translate-y-1/2 w-4 h-4 rounded-full border-[3px] border-white shadow-md z-10 transition-transform group-hover:scale-125 ${POINT_COLORS[point.type]
                                        }`}
                                ></div>
